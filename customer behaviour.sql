...
SELECT 
    shipping_type,
    ROUND(AVG("purchase_amount_(usd)")::numeric, 2) AS avg_purchase_amount
FROM customer
WHERE shipping_type IN ('Standard', 'Express')
GROUP BY shipping_type;

-- Q5. Do subscribed customers spend more?
-- Compare total customers, average spend, and total revenue
SELECT 
    subscription_status,
    COUNT(customer_id) AS total_customers,
    ROUND(AVG("purchase_amount_(usd)")::numeric, 2) AS avg_spend,
    ROUND(SUM("purchase_amount_(usd)")::numeric, 2) AS total_revenue
FROM customer
